...
```{r}
d <- chart(flower_evo, ~ petal_lg  %col=% flower) + geom_density()

e <- chart(flower_evo, ~ male_lg  %col=% flower) + geom_density()

f <- chart(flower_evo, ~ fml_lg  %col=% flower) + geom_density()
...
```{r}
chart(fruit_evo, perimeter ~ age )+ geom_point()
```
